...
CREATE TABLE IF NOT EXISTS `accounts` (
    ...
    `last_valid_code_at` DATETIME DEFAULT NULL,
    `last_code_source` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `last_code_capture_at` DATETIME DEFAULT NULL,
    `last_code_capture_by` VARCHAR(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
    `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uin` (`uin`),
    KEY `idx_accounts_username` (`username`),
    KEY `idx_accounts_open_id` (`open_id`),
    KEY `idx_accounts_last_valid_code_at` (`last_valid_code_at`),
...
CREATE TABLE IF NOT EXISTS `friend_risk_profiles` (
    ...
    `friend_uin` VARCHAR(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `friend_open_id` VARCHAR(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `friend_name` VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `risk_score` INT NOT NULL DEFAULT '0',
    `risk_level` VARCHAR(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'low',
    `strategy_state` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'observe',
    `tags` JSON DEFAULT NULL,
    `last_hit_reason` VARCHAR(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `friend_steal_stats` (
    ...
    `last_mode` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'auto',
